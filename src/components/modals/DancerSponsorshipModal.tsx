                    ...
                    {loadingDancers ? (
                      ...
                      dancers.filter(d => d.is_active).map((dancer) => (
                        <button
                          ...
                          className={`group relative w-full rounded-[3rem] overflow-hidden transition-all duration-700 border-2 bg-white ${
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col justify-between py-2 sm:py-4">
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3 pt-2">
                        <p className="text-[10px] uppercase tracking-[0.5em] text-brand-dark/30 font-black ml-4">FORMA DE PAGAMENTO</p>
